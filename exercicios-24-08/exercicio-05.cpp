...
main(){
    ...
    while(true){
        ...
        if(serie == 3 && gostaRedacao == 0) contador3SerieENaoGostaRedacao++;
    ...
    cout << "A porcentagem de alunos que não gostam de fazer redação e que estão na terceira série é "<< contador3SerieENaoGostaRedacao/contadorAlunosTotais*100<<"%"<<endl;
